...
void test_constant_comparable(const Comparable& test, const Comparable& test_24, const Comparable& test_42, const Comparable& test_84); 
...
int main() {
	...
	test_constant_comparable(test, test_24, test_42, test_84);
	test_constant_comparable(test3, test2_24, test2_42, test2_84);
